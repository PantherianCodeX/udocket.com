...
- 2025-10-05: Converted vendored stubs to on-demand generation; `typings/vendor/` is git-ignored and the helper now requires `--force` to regenerate populated directories.
