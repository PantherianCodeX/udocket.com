"""Centralised path helpers and service-area metadata for docs tooling."""
...
# Repository and directory roots
REPO_ROOT = Path(__file__).resolve().parents[4]
DOCS_PACKAGE_ROOT = REPO_ROOT / "packages" / "udocket_docs"
DOCS_ROOT = REPO_ROOT / "docs"
CONFIG_ROOT = DOCS_PACKAGE_ROOT / "config"
BUILD_ROOT = DOCS_PACKAGE_ROOT / "build"
DOC_BUILDS_ROOT = REPO_ROOT / "doc-builds"
