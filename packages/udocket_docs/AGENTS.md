...
- Prefer running tasks through the docs toolbox container via `make docs.build`, `make docs.lint`, etc.; the Make targets launch the curated toolbox so MkDocs, WeasyPrint, Vale, and Mermaid share cached layers.
