...
- All documentation sources live under `packages/udocket_docs/docs/` (symlinked at `/docs` for convenience).
...
- Use `python -m docs.tools.manage_docs --lint` (or the Makefile targets) before submitting changes; CI mirrors this exact pipeline.
