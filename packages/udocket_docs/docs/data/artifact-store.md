...
- **Maintenance:** Run `python -m docs.tools.manage_docs --lint docs/src/data/artifact-store.md docs/src/overview/tdd.md docs/tdd_modularization.md` before submitting. Changes to storage layout or retention policy require synchronized updates to migration scripts and Appendix J tables.
...
**Breadcrumbs:** Runbooks `docs/src/ops/runbooks/artifacts/*.md`, incident retros in `ops/artifacts/incidents/`. **|**
...
**Breadcrumbs:** Terraform modules `infra/terraform/artifact_store`, runbooks `docs/src/ops/runbooks/artifacts/*.md`, automation scripts `scripts/ops/artifacts/*.py`. **|**
...
**Breadcrumbs:** Runbook overview `docs/src/ops/runbooks/artifacts/README.md`, staffing policy `ops/artifacts/policies/staffing.md`. **|**
