...
COMPOSE_STAGE_PROFILES: dict[str, ComposeStageProfile] = {
    "compose.context": ComposeStageProfile(
        ...
        description=(
            "Condense intake metadata, staff findings, and approved summary outputs into "
            "ComposeContext."
        ),
        ...
        resource_notes=(
            "Include intake answers, staff report highlights, and timeline/entity payloads "
            "when present."
        ),
    ),
    "compose.client.draft": ComposeStageProfile(
        ...
        description=(
            "Draft the client-facing Markdown deliverable with mandated headings and "
            "empathetic tone."
        ),
        ...
        resource_notes=(
            "Supply ComposeContext JSON and tone guardrails; cite transcript timestamps when "
            "available."
        ),
    ),
    "compose.client.revise": ComposeStageProfile(
        ...
        output_reserve_tokens=6000,
        resource_notes=(
            "Provide the previous draft, revision brief, and outstanding guard errors in context."
        ),
    ),
    "compose.client.structure": ComposeStageProfile(
        ...
        description=(
            "Deterministically verify client headings, ordering, and section length requirements."
        ),
    ...
    "compose.client.compliance": ComposeStageProfile(
        ...
        description=(
            "Detect advice, predictions, or disallowed tone within the client deliverable."
        ),
        min_context_tokens=4000,
        recommended_context_tokens=8000,
        target_chunk_tokens=2000,
    ...
    "compose.client.factuality": ComposeStageProfile(
        ...
        resource_notes=(
            "Requires ComposeContext claimable atoms and timeline seeds for cross-checks."
        ),
    ),
    "compose.client.qa_reviewer": ComposeStageProfile(
        ...
        description=(
            "LLM QA pass covering structure, compliance, and factuality for the client lane."
        ),
        min_context_tokens=16000,
        recommended_context_tokens=32000,
        ...
        output_reserve_tokens=2000,
        resource_notes=(
            "Provide latest draft, ComposeContext, and guard findings when QA is enabled."
        ),
    ),
    ...
    "compose.client.editor": ComposeStageProfile(
        ...
        description=(
            "Perform constrained, non-factual edits requested by QA for the client deliverable."
        ),
        ...
        resource_notes=(
            "Context should include revision brief, allowed edit types, and latest draft."
        ),
    ),
    "compose.lawyer.draft": ComposeStageProfile(
        ...
        description=(
            "Draft the lawyer-facing Markdown brief with evidentiary framing and required headings."
        ),
        ...
        resource_notes=(
            "Supply ComposeContext, transcript cites, and outstanding legal issues for reference."
        ),
    ),
    ...
    "compose.lawyer.structure": ComposeStageProfile(
        ...
        description=(
            "Deterministically verify lawyer headings, ordering, and section length requirements."
        ),
        min_context_tokens=4000,
        recommended_context_tokens=8000,
        target_chunk_tokens=2000,
    ...
    "compose.lawyer.compliance": ComposeStageProfile(
        ...
        description=(
            "Detect disallowed advice, advocacy, or speculative language in the lawyer deliverable."
        ),
        min_context_tokens=4000,
        recommended_context_tokens=8000,
        target_chunk_tokens=2000,
    ...
    "compose.lawyer.factuality": ComposeStageProfile(
        ...
        output_reserve_tokens=1000,
        resource_notes=(
            "Requires ComposeContext claimable atoms, timeline seeds, and entity hints."
        ),
    ),
    "compose.lawyer.qa_reviewer": ComposeStageProfile(
        ...
        description=(
            "LLM QA pass covering structure, compliance, and factuality for the lawyer lane."
        ),
        min_context_tokens=16000,
        recommended_context_tokens=32000,
        target_chunk_tokens=6000,
        output_reserve_tokens=2000,
        resource_notes=(
            "Provide latest lawyer draft, ComposeContext, and guard summaries when QA is enabled."
        ),
    ),
    "compose.lawyer.qa_revision": ComposeStageProfile(
        ...
        description=(
            "Prepares revision briefs and resets the lawyer lane according to QA directives."
        ),
        min_context_tokens=2000,
        recommended_context_tokens=4000,
        target_chunk_tokens=1000,
    ...
    "compose.lawyer.editor": ComposeStageProfile(
        ...
        description=(
            "Perform constrained, non-factual edits requested by QA for the lawyer deliverable."
        ),
        min_context_tokens=8000,
        recommended_context_tokens=16000,
        target_chunk_tokens=4000,
    ...
    "compose.release_gate": ComposeStageProfile(
        ...
        label="Release Gate",
        description=(
            "Final guard ensuring both lanes have passing outcomes and QA approvals before "
            "artifact write-out."
        ),
        min_context_tokens=2000,
        recommended_context_tokens=4000,
