(function () {
  if (window.udocketCaseDetailInitialized) {
    return;
  }
  window.udocketCaseDetailInitialized = true;
  ...
  const initialToolKey = caseView.getAttribute('data-initial-tool') || '';
  ...
  window.JobsState = window.JobsState || {
