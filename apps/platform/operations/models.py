...
class LLMProviderCredential(models.Model):
    ...
    uid: models.UUIDField[uuid.UUID, uuid.UUID] = models.UUIDField(default=uuid.uuid4, editable=False, unique=True)
    ...
    models_payload: models.JSONField[list[dict[str, Any]], list[dict[str, Any]]] = models.JSONField(default=list, blank=True)
    ...
    @classmethod
    def typed_objects(cls) -> models.Manager["LLMProviderCredential"]:
        return cast(models.Manager["LLMProviderCredential"], cls.objects)

    @classmethod
    def scoped(cls) -> models.Manager["LLMProviderCredential"]:
...
class LLMConfiguration(models.Model):
    ...
    provider_chain: models.JSONField[list[str], list[str]] = models.JSONField(default=list, blank=True)
    stage_map: models.JSONField[dict[str, dict[str, Any]], dict[str, dict[str, Any]]] = models.JSONField(default=dict, blank=True)
    ...
    @classmethod
    def typed_objects(cls) -> models.Manager["LLMConfiguration"]:
        return cast(models.Manager["LLMConfiguration"], cls.objects)

    @classmethod
    def scoped(cls) -> models.Manager["LLMConfiguration"]:
        return cls.typed_objects()
...
class AuditEvent(models.Model):
    ...
    data: models.JSONField[dict[str, Any], dict[str, Any]] = models.JSONField(default=dict, blank=True)

    @classmethod
    def typed_objects(cls) -> models.Manager["AuditEvent"]:
        return cast(models.Manager["AuditEvent"], cls.objects)

    @classmethod
    def scoped(cls) -> models.Manager["AuditEvent"]:
        return cls.typed_objects()
...
class GuardianSettings(models.Model):
    ...
    instructions: models.JSONField[list[dict[str, Any]], list[dict[str, Any]]] = models.JSONField(default=list, blank=True)
    created_at: models.DateTimeField[datetime, datetime] = models.DateTimeField(auto_now_add=True)
    updated_at: models.DateTimeField[datetime, datetime] = models.DateTimeField(auto_now=True)
    ...
    @classmethod
    def typed_objects(cls) -> models.Manager["GuardianSettings"]:
        return cast(models.Manager["GuardianSettings"], cls.objects)

    @classmethod
    def scoped(cls) -> models.Manager["GuardianSettings"]:
        return cls.typed_objects()
