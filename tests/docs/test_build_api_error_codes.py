...
from scripts.docs import build_api_error_codes as generator
...
def _setup_workspace(tmp_path: Path, monkeypatch: pytest.MonkeyPatch) -> Path:
    ...
    monkeypatch.setattr(generator, "SERVICES_DIR", docs_root / "services")
    monkeypatch.setattr(generator, "APPS_DIR", docs_root / "apps")
