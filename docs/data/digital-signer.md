...
- **Maintenance:** Run `python -m doc_tools.manage_docs --lint` and `python -m doc_tools.check_links --strict` before proposing signer changes. Signing policy or PKI updates require ADR references in the PR.
