...
header-includes:
  ...
  - |
    <header class="page-header">uDocket — Audit &amp; Evidence Specification <br> Immutable Records, Seals, and Compliance Telemetry</header>
  - |
...
- **Change protocol:** Any schema or seal change must update this document, reference relevant ADRs, and demonstrate seal verification in staging. Run `python -m doc_tools.check.structure docs/data/audit.md` prior to submission.
