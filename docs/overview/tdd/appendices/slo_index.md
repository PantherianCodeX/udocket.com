...
**Breadcrumbs:** Prometheus rules `infra/monitoring/logging-prometheus-rules.yaml`, seal runner `ops/audit/seal_runner.py`, runbooks `docs/ops/runbooks/logging/*.md`. **|**
