...
- **Maintenance:** Run `python -m docs.tools.manage_docs --lint docs/src/customer/billing-subscriptions.md docs/src/overview/tdd.md docs/tdd_modularization.md` before submitting. Contract changes must update TDD billing tables and Ops runbooks `RB-BILLING-*`.
...
**Breadcrumbs:** Runbooks `docs/src/ops/runbooks/billing/*.md`, incident retros `ops/billing/incidents/*.md`. **|**
...
**Breadcrumbs:** Runbooks `docs/src/ops/runbooks/billing/*.md`, automation `scripts/ops/billing_*.py`, FinOps reports `ops/finops/reports/`. **|**
...
**Breadcrumbs:** Staffing policy `ops/billing/policies/staffing.md`, incident response guide `docs/src/ops/runbooks/billing/README.md`. **|**
