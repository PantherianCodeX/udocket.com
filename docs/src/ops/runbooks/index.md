...
- [Localization & Policy Engine — Appendix R — Runbooks & drills (binding)](#localization-policy-engine-appendix-r-runbooks-drills-binding)
  - [Localization & Policy Engine — R.1 Runbook index (informative)](#localization-policy-engine-r-1-runbook-index-informative)
  - [Localization & Policy Engine — R.2 RB-LPE-COMPILER — Compiler diff triage (binding)](#localization-policy-engine-r-2-rb-lpe-compiler-compiler-diff-triage-binding)
  - [Localization & Policy Engine — R.3 RB-OPA-ROLLBACK — OPA bundle rollback (binding)](#localization-policy-engine-r-3-rb-opa-rollback-opa-bundle-rollback-binding)
  - [Localization & Policy Engine — R.4 RB-LPE-WAIVER — Waiver expiry response (binding)](#localization-policy-engine-r-4-rb-lpe-waiver-waiver-expiry-response-binding)
  - [Localization & Policy Engine — R.5 RB-LPE-LOCALE-GAP — Localization coverage gap (binding)](#localization-policy-engine-r-5-rb-lpe-locale-gap-localization-coverage-gap-binding)
- [Reference Manager — Appendix R — Runbooks & drills](#reference-manager-appendix-r-runbooks-drills)
  - [Reference Manager — R.1 Runbook index (informative)](#reference-manager-r-1-runbook-index-informative)
  - [Reference Manager — R.2 RB-RM-ROLLBACK — Reference bundle rollback & adoption freeze (binding)](#reference-manager-r-2-rb-rm-rollback-reference-bundle-rollback-adoption-freeze-binding)
  - [Reference Manager — R.3 RB-RM-HARVEST — Source harvest incident triage (binding)](#reference-manager-r-3-rb-rm-harvest-source-harvest-incident-triage-binding)
  - [Reference Manager — R.4 RB-RM-PUBLISH — Publish guard failure response (binding)](#reference-manager-r-4-rb-rm-publish-publish-guard-failure-response-binding)
  - [Reference Manager — R.5 RB-RM-LICENSE — License violation remediation (binding)](#reference-manager-r-5-rb-rm-license-license-violation-remediation-binding)
  - [Reference Manager — R.6 RB-RM-RESIDENCY — Residency endpoint alignment (binding)](#reference-manager-r-6-rb-rm-residency-residency-endpoint-alignment-binding)
- [Settings Registry — Appendix R — Runbooks & drills](#settings-registry-appendix-r-runbooks-drills)
  - [Settings Registry — R.1 Runbook index (informative)](#settings-registry-r-1-runbook-index-informative)
  - [Settings Registry — R.2 RB-GOV-008 — Settings governance toggle / rollback (binding)](#settings-registry-r-2-rb-gov-008-settings-governance-toggle-rollback-binding)
  - [Settings Registry — R.3 RB-RES-ENDPOINT — Residency endpoint drift remediation (binding)](#settings-registry-r-3-rb-res-endpoint-residency-endpoint-drift-remediation-binding)
  - [Settings Registry — R.4 RB-RES-BLOCK — Residency waiver / block handling (binding)](#settings-registry-r-4-rb-res-block-residency-waiver-block-handling-binding)
  - [Settings Registry — R.5 RB-LOCK-006 — Activation lock stale detection & remediation (binding)](#settings-registry-r-5-rb-lock-006-activation-lock-stale-detection-remediation-binding)
  - [Settings Registry — R.6 RB-LLM-003 — Provider degradation / circuit breaker (binding)](#settings-registry-r-6-rb-llm-003-provider-degradation-circuit-breaker-binding)
  - [Settings Registry — R.7 RB-JOB-WATCHDOG — Job stall watchdog (binding)](#settings-registry-r-7-rb-job-watchdog-job-stall-watchdog-binding)
  - [Settings Registry — R.8 RB-UPLOAD-SCAN — Upload scanning outage response (binding)](#settings-registry-r-8-rb-upload-scan-upload-scanning-outage-response-binding)
- [Guardian Service — Appendix R — Runbooks & drills (binding)](#guardian-service-appendix-r-runbooks-drills-binding)
  - [Guardian Service — R.1 Response index (informative)](#guardian-service-r-1-response-index-informative)
  - [Guardian Service — R.2 RB-GUARD-001 — Guardian SLO breach (binding)](#guardian-service-r-2-rb-guard-001-guardian-slo-breach-binding)
  - [Guardian Service — R.3 RB-GUARD-QUAR — Quarantine spike investigation (binding)](#guardian-service-r-3-rb-guard-quar-quarantine-spike-investigation-binding)
  - [Guardian Service — R.4 RB-GUARD-QUEUE — Submission backlog watchdog (binding)](#guardian-service-r-4-rb-guard-queue-submission-backlog-watchdog-binding)
  - [Guardian Service — R.5 RB-GUARD-MANUAL — Manual review reconciliation (informative)](#guardian-service-r-5-rb-guard-manual-manual-review-reconciliation-informative)
