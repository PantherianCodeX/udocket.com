...
- **Maintenance:** Run `python -m docs.tools.manage_docs --lint docs/src/data/search-index.md docs/src/overview/tdd.md docs/tdd_modularization.md`. Updates require sync with product PRDs and LLM Registry (embedding models).
