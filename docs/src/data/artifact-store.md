...
- **Maintenance:** Run `python -m docs.tools.lint_docs docs/src/data/artifact-store.md docs/src/overview/tdd.md docs/tdd_modularization.md` before submitting. Changes to storage layout or retention policy require synchronized updates to migration scripts and Appendix J tables.
