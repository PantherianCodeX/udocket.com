...
**Breadcrumbs:** PagerDuty config `ops/pagerduty/agents.json`, alert catalog `docs/src/ops/runbooks/alert_catalog.md`, synthetic configs `infra/synthetics/agents_shadow.yaml`, QA policy `docs/policy/langgraph_incident_policy.md`. **|**
