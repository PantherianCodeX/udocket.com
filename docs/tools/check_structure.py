...
Typical usage (CLI/CI friendly):
    ...
    python -m docs.tools.check_structure
    python -m docs.tools.check_structure docs/src/experience/web-app.md
    python -m docs.tools.check_structure docs/src/platform docs/src/automation docs/src/data docs/src/customer docs/src/overview
"""
